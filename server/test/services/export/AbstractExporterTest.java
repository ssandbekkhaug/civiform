...
public abstract class AbstractExporterTest extends ResetPostgres {
  ...
  protected void createFakeProgramWithOptionalQuestion() {
    ...
    applicationFive =
        new ApplicationModel(applicantFive, fakeProgramWithOptionalFileUpload, LifecycleStage.ACTIVE);
    applicantFive.save();
    ...
    QuestionAnswerer.answerNameQuestion(
        ...
        "Six");
    applicationSix =
        new ApplicationModel(applicantSix, fakeProgramWithOptionalFileUpload, LifecycleStage.ACTIVE);
    applicantSix.save();
    CfTestHelpers.withMockedInstantNow(
