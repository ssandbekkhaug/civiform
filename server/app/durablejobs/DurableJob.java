 ...
 * {@link PersistedDurableJobModel} records in the database, making them durable to server failures and
 * allowing automated retry logic. The behavior of a {@code DurableJob} is determined by its
 * implementing class, which is identified by its associated {@link PersistedDurableJobModel} record via
