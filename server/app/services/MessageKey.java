...
public enum MessageKey {
  ...
  CONTENT_APRIL("content.april"),
  CONTENT_AUGUST("content.august"),
  ...
  CONTENT_DECEMBER("content.december"),
  ...
  CONTENT_FEBRUARY("content.february"),
  CONTENT_FIND_PROGRAMS("content.findPrograms"),
  CONTENT_GUEST_DESCRIPTION("content.guestDescription"),
  CONTENT_JANUARY("content.january"),
  CONTENT_JULY("content.july"),
  CONTENT_JUNE("content.june"),
  ...
  CONTENT_MARCH("content.march"),
  CONTENT_MAY("content.may"),
  ...
  CONTENT_NOVEMBER("content.november"),
  CONTENT_NUMBER_OF_APP_SUBMITTED("content.numberOfAppSubmitted"),
  CONTENT_OCTOBER("content.october"),
  ...
  CONTENT_SEPTEMBER("content.september"),
  CONTENT_WARNING("content.warning"),
  DAY_OF_MONTH_LABEL("label.dayOfMonth"),
